...
blocks:
  ...
  - discriminant: ContentBlock
    value:
      name: team-intro
      body: >-
        <h2>Die Menschen hinter EOS</h2><p>Unser Team besteht aus zertifizierten
        Lehrern mit jahrelanger Erfahrung. Jede/r bringt eine einzigartige
        Perspektive und Leidenschaft für Bewegung und Wohlbefinden mit.</p>
      fullBleed: false
  ...
  - discriminant: InteractiveListBlock
    value:
      ...
      items:
        - label: Anna Müller
          description: Senior Yoga Instructor, 10+ Jahre Erfahrung
          image: /assets/theme_yoga.png
          imageAlt: Anna Müller - Yoga Instructor
        - label: Thomas Schmidt
          description: Pilates & Core Trainer, Physiotherapeut
